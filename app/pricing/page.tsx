...
const plans = [
  ...
  { id: "personal", name: "Personal", monthlyPrice: 5.99, description: "Para vestir mejor con lo que ya tienes.", features: ["Hasta 75 prendas", "15 prendas nuevas al mes", "Looks y planificación semanal", "Asistente según tu estilo y closet"], recommended: true },
  { id: "club", name: "Club", monthlyPrice: 11.99, description: "Para closets grandes y una lectura más profunda.", features: ["Hasta 250 prendas", "40 prendas nuevas al mes", "3 reprocesos en calidad media", "Prioridad, análisis e insights avanzados"] },
];
